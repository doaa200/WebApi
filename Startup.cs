...
namespace Day1of_WenApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //{
            //    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Day1of_WenApi", Version = "v1" });
            //});
            ...
            services.AddDbContext<SouqEntity>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Day1of_WenApi v1"));
            }
